...
hplc_msms_analysis("std_concentrations.csv",
                   "mg_sample.csv",
                   "python_data.csv",
                   "final_coding_project.rawdata.rawdata.",
                   "plot.pdf",
                   "output.csv")
...
hplc_msms_analysis <- function(stdfile,
                               mgfile,
                               pythonfile,
                               wd, # eg, "final_coding_project.rawdata.", see README file
                               plot,
                               output){
  ...
  data$sample = gsub("^X|.CSV|_r1|_r2", "", data$sample)
  # Delete working directory in sample names
  data$sample = gsub(wd, "", data$sample)
